                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              UText(
                                title: StoreManager().isEnglish?data.albumL1.toString():data.albumL2.toString(),
                                fontName: FontName.helveticaBold,
                                maxLine: 1,
                              ),
                              UText(
                                title: StoreManager().isEnglish?data.artistL1.toString():data.artistL2.toString(),//data.artistL1.toString(),
                                textColor: grey,
                                maxLine: 1,
                              ),
                              SizedBox(height: 8),
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: playButton(TuneInfo(), () => null),
                                  ),
                                  SizedBox(width: 20),
                                  Expanded(
