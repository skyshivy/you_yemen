...
//           ),
//           Expanded(
//             child: FutureBuilder<FaqModal>(
//               future: getFaqDetailApi(),
//               builder: (context, snapshot) {
//                 if (snapshot.connectionState == ConnectionState.waiting) {
//                   return Center(child: loadingIndicator(radius: 20));
//                 } else if (snapshot.hasError) {
//                   return Center(child: Text('Error: ${snapshot.error}'));
//                 } else if (!snapshot.hasData || snapshot.data!.faqList!.isEmpty) {
//                   return Center(child: Text('No data available'));
//                 } else {
//                   return ListView.builder(
//                     itemCount: snapshot.data?.faqList?.length,
//                     itemBuilder: (context, index) {
//                       return ContainerListItem(snapshot.data?.faqList?[index]??FaqList());
//                     },
//                   );
//                 }
//               },
