...
addtoWishListApi(TuneInfo info) async {
  ...
  Map<String, dynamic> jsonMap = {
    ...
    "contentPath":info.toneIdStreamingUrl,//"https://ringtune.mpt.com.mm/stream-media/get-tone-path?fileId=XdYn8fG+ceO+CZyOn8viaA==",
    ...
    "contentName_L2":info.toneName,//StoreManager().isEnglish?'':info.toneName,//"contentName_L2",
    "album_L2":'',
    "artist_L2":"",
    "price":info.price,
