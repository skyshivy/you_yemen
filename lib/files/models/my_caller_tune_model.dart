...
//
//     final mycallertuneModel = mycallertuneModelFromJson(jsonString);

import 'dart:convert';

MycallertuneModel mycallertuneModelFromJson(String str) => MycallertuneModel.fromJson(json.decode(str));

String mycallertuneModelToJson(MycallertuneModel data) => json.encode(data.toJson());

class MycallertuneModel {
    ...
    factory MycallertuneModel.fromJson(Map<String, dynamic> json) => MycallertuneModel(
